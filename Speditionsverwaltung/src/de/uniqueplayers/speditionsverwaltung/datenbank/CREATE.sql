...
CONSTRAINT f_idFK FOREIGN KEY(f_id) REFERENCES spediverwaltung.fahrer
);
...
CONSTRAINT f_idFK FOREIGN KEY(f_id) REFERENCES spediverwaltung.fahrer,
CONSTRAINT sp_idFK FOREIGN KEY(sp_id) REFERENCES spediverwaltung.spedition
);
...
CONSTRAINT f_EmailFK FOREIGN KEY(f_Email) REFERENCES spediverwaltung.fahrer,
CONSTRAINT f_idFK FOREIGN KEY(f_id) REFERENCES spediverwaltung.fahrer,
CONSTRAINT f_nachname FOREIGN KEY(f_nachname) REFERENCES spediverwaltung.fahrer,
CONSTRAINT f_vorname FOREIGN KEY(f_vorname) REFERENCES spediverwaltung.fahrer,
CONSTRAINT sp_idFK FOREIGN KEY(sp_id) REFERENCES spediverwaltung.spedition
);
...
f_username      VARCHAR(500),
f_passwort      HASH,
CONSTRAINT f_EmailPK PRIMARY KEY(f_Email),
CONSTRAINT f_EmailFK FOREIGN KEY(f_Email) REFERENCES spediverwaltung.fahrer,
CONSTRAINT f_usernameFK FOREIGN KEY(f_username) REFERENCES spediverwaltung.fahrer,
CONSTRAINT f_passwortFK FOREIGN KEY(f_passwort) REFERENCES spediverwaltung.fahrer
);
